...
class ServiceController extends Controller
{
    ...
    private $url_site = 'https://delta.noava.com.br/iesde/public';
    ...
    public function pdfLinks(Request $request){
        ...
        return view('welcome', ['disciplinas' => $disciplinas, 'matriculaID' => $request->matriculaID, 'aulas' => $getAulas, 'url_site' => $this->url_site]);
